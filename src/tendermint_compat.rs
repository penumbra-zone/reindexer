...
//!
//! These custom types will be used in the definition of the `Penumbra` trait.
...
impl TryFrom<v0o37::tendermint::Block> for Block {
    type Error = anyhow::Error;
    fn try_from(block: v0o37::tendermint::Block) -> anyhow::Result<Block> {
        let block = Block(v0o40::tendermint::Block::new(
            ...
            v0o40::tendermint::evidence::List::new(block.evidence.into_vec().into_iter().collect()),
                ...
                Some(last_commit) => Some(v0o40::tendermint::block::Commit {
                    ...
                    block_id: v0o40::tendermint::block::Id {
                        hash: match last_commit.block_id.hash {
                            v0o37::tendermint::Hash::Sha256(h) => {
                                v0o40::tendermint::Hash::Sha256(h)
                            }
                            v0o37::tendermint::Hash::None => v0o40::tendermint::Hash::None,
                        },
                    ...
                    signatures: last_commit
                        ...
                        .iter()
                        .map(|s| match s {
                            v0o37::tendermint::block::commit_sig::CommitSig::BlockIdFlagAbsent => {
                                v0o40::tendermint::block::commit_sig::CommitSig::BlockIdFlagAbsent
                            }
                            v0o37::tendermint::block::commit_sig::CommitSig::BlockIdFlagCommit { ref validator_address, ref timestamp, ref signature }  => 
                            ...
                            v0o37::tendermint::block::commit_sig::CommitSig::BlockIdFlagNil { ref validator_address, ref timestamp, ref signature } =>
...
impl TryInto<v0o37::BeginBlock> for BeginBlock {
    type Error = anyhow::Error;
    fn try_into(self) -> anyhow::Result<v0o37::BeginBlock> {
        let bb: v0o37::BeginBlock = v0o37::BeginBlock {
            hash: v0o37::tendermint::hash::Hash::Sha256(self.0.hash.as_bytes().try_into()?),
            header: v0o37::tendermint::block::Header {
                version: v0o37::tendermint::block::header::Version {
                    // Version is a tuple of u64s, so it's easy to unpack.
                    block: self.0.header.version.block,
                    app: self.0.header.version.app,
                },
                // chain_id is just a string
                chain_id: v0o37::tendermint::chain::id::Id::try_from(
                    self.0.header.chain_id.as_str(),
                )?,
                // Height is a u64 inside, so easy enough
                height: v0o37::tendermint::block::Height::try_from(self.0.header.height.value())?,
                // TODO: should the nanos be 0? am i doubling the evaluted time by summing (time +
                // time-in-nanos)?
                time: v0o37::tendermint::time::Time::from_unix_timestamp(
                ...
                last_block_id: match self.0.header.last_block_id {
                    Some(last_block_id) => Some(v0o37::tendermint::block::Id {
                        hash: v0o37::tendermint::hash::Hash::Sha256(
                            last_block_id.hash.as_bytes().try_into()?,
                        ),
                        part_set_header: v0o37::tendermint::block::parts::Header::new(
                            last_block_id.part_set_header.total,
                            v0o37::tendermint::hash::Hash::Sha256(
                                last_block_id.hash.as_bytes().try_into()?,
                            ),
                        )?,
                    }),
                ...
                last_commit_hash: match self.0.header.last_commit_hash {
                    Some(last_commit_hash) => Some(v0o37::tendermint::hash::Hash::Sha256(
                        last_commit_hash.as_bytes().try_into()?,
                    )),
                    None => None,
                },
                ...
                data_hash: match self.0.header.data_hash {
                    Some(data_hash) => Some(v0o37::tendermint::hash::Hash::Sha256(
                        data_hash.as_bytes().try_into()?,
                    )),
                    None => None,
                },
                // Round-trip as bytes
                validators_hash: v0o37::tendermint::hash::Hash::Sha256(
                    self.0.header.validators_hash.as_bytes().try_into()?,
                ),
                // Round-trip as bytes
                next_validators_hash: v0o37::tendermint::hash::Hash::Sha256(
                    self.0.header.next_validators_hash.as_bytes().try_into()?,
                ),
                // Round-trip as bytes
                consensus_hash: v0o37::tendermint::hash::Hash::Sha256(
                    self.0.header.consensus_hash.as_bytes().try_into()?,
                ),
                // Round-trip as bytes
                app_hash: v0o37::tendermint::hash::AppHash::try_from(
                    self.0.header.app_hash.as_bytes().to_vec(),
                )?,
                // Easy enough to round-trip the bytes representation, and retain the Option value.
                last_results_hash: match self.0.header.last_results_hash {
                    Some(last_results_hash) => Some(v0o37::tendermint::hash::Hash::Sha256(
                        last_results_hash.as_bytes().try_into()?,
                    )),
                    None => None,
                },
                ...
                evidence_hash: match self.0.header.evidence_hash {
                    Some(evidence_hash) => Some(v0o37::tendermint::hash::Hash::Sha256(
                        evidence_hash.as_bytes().try_into()?,
                    )),
                    None => None,
                },
                // Round-trip as bytes.
                proposer_address: v0o37::tendermint::account::Id::new(
                    self.0.header.proposer_address.as_bytes().try_into()?,
                ),
            },
            last_commit_info: v0o37::tendermint::abci::types::CommitInfo {
                ...
                votes: self
                    ...
                    .votes
                    .iter()
                    .map(|vote_info| v0o37::tendermint::abci::types::VoteInfo {
                        validator: v0o37::tendermint::abci::types::Validator {
                        ...
                        sig_info: match vote_info.sig_info {
                            v0o40::tendermint::abci::types::BlockSignatureInfo::Flag(
                                ...
                                v0o40::tendermint::block::BlockIdFlag::Absent => {
                                    v0o37::tendermint::abci::types::BlockSignatureInfo::Flag(
                                        v0o37::tendermint::block::BlockIdFlag::Absent,
                                    )
                                }
                                v0o40::tendermint::block::BlockIdFlag::Commit => {
                                    v0o37::tendermint::abci::types::BlockSignatureInfo::Flag(
                                        v0o37::tendermint::block::BlockIdFlag::Commit,
                                    )
                                }
                                v0o40::tendermint::block::BlockIdFlag::Nil => {
                                    v0o37::tendermint::abci::types::BlockSignatureInfo::Flag(
                                        v0o37::tendermint::block::BlockIdFlag::Nil,
                                    )
                                }
                            },
                            v0o40::tendermint::abci::types::BlockSignatureInfo::LegacySigned => {
                                v0o37::tendermint::abci::types::BlockSignatureInfo::LegacySigned
                            }
                        },
                    })
                    .collect(),
            ...
            byzantine_validators: self
                ...
                .iter()
                .map(|misbehavior| v0o37::tendermint::abci::types::Misbehavior {
                    kind: match misbehavior.kind {
                        v0o40::tendermint::abci::types::MisbehaviorKind::Unknown => {
                            v0o37::tendermint::abci::types::MisbehaviorKind::Unknown
                        }
                        v0o40::tendermint::abci::types::MisbehaviorKind::DuplicateVote => {
                            v0o37::tendermint::abci::types::MisbehaviorKind::DuplicateVote
                        }
                        v0o40::tendermint::abci::types::MisbehaviorKind::LightClientAttack => {
                            v0o37::tendermint::abci::types::MisbehaviorKind::LightClientAttack
                        }
                    },
                    validator: v0o37::tendermint::abci::types::Validator {
                    ...
                    // Height is a u64 inside, so easy enough
                    height: v0o37::tendermint::block::Height::try_from(misbehavior.height.value())
                    ...
                    total_voting_power: v0o37::tendermint::vote::Power::try_from(
...
// impl From<v0o37::tendermint::Block> for BeginBlock {
//     fn from(block: v0o37::tendermint::Block) -> BeginBlock {
...
impl Into<v0o37::tendermint::abci::request::EndBlock> for EndBlock {
    fn into(self) -> v0o37::tendermint::abci::request::EndBlock {
        v0o37::tendermint::abci::request::EndBlock {
            height: self.height,
        }
    }
}
...
/// Trivial conversion from compat type to v0.37 format.
impl Into<v0o37::tendermint::abci::request::DeliverTx> for DeliverTx {
    fn into(self) -> v0o37::tendermint::abci::request::DeliverTx {
        v0o37::tendermint::abci::request::DeliverTx { tx: self.tx.into() }
    }
}
...
impl TryFrom<v0o37::tendermint::abci::types::Validator> for Validator {
    type Error = anyhow::Error;
    fn try_from(validator: v0o37::tendermint::abci::types::Validator) -> anyhow::Result<Validator> {
        Ok(Validator {
...
impl TryInto<v0o37::tendermint::abci::types::Validator> for Validator {
    type Error = anyhow::Error;
    fn try_into(self) -> anyhow::Result<v0o37::tendermint::abci::types::Validator> {
        Ok(v0o37::tendermint::abci::types::Validator {
            address: self.address,
            power: self.power.try_into()?,
        })
    }
...
/// copied wholesale from the penumbra.rs jawn
fn evidence_to_misbehavior(evidence: &v0o40::tendermint::evidence::Evidence) -> Vec<v0o40::tendermint::abci::types::Misbehavior> {
    match evidence {
        v0o40::tendermint::evidence::Evidence::DuplicateVote(bad) => vec![v0o40::tendermint::abci::types::Misbehavior {
        ...
        v0o40::tendermint::evidence::Evidence::LightClientAttack(bad) => bad
            .byzantine_validators
            .iter()
